        ...
        <div className="mx-auto p-4 md:p-8">
          ...
          <div className="flex-1 lg:max-h-[calc(89vh-100px)] max-h-[calc(70vh-100px)] overflow-y-auto pr-2 custom-scrollbar">
            {isLoadingAll ? (
              ...
              <div className="border rounded-sm divide-y bg-card overflow-hidden shadow-xs">
                {displayPubs.map((pub) => (
                  <div key={pub.symbol} className="group flex flex-col p-0 hover:bg-zinc-50 dark:hover:bg-zinc-800/50 transition-colors">
